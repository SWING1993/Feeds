...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarTintColor = UIColorMake(31, 31, 31);                                     // NavBarTintColor : QMUINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    QMUICMI.navBarTitleColor = NavBarTintColor;                                 // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    QMUICMI.navBarTitleFont = UIFontLightMake(16);                               // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
...
#pragma mark - QMUILog
    QMUICMI.shouldPrintDefaultLog = kShouldPrint;                                        // ShouldPrintDefaultLog : 是否允许输出 QMUILogLevelDefault 级别的 log
    QMUICMI.shouldPrintInfoLog = kShouldPrint;                                           // ShouldPrintInfoLog : 是否允许输出 QMUILogLevelInfo 级别的 log
    QMUICMI.shouldPrintWarnLog = kShouldPrint;                                           // ShouldPrintInfoLog : 是否允许输出 QMUILogLevelWarn 级别的 log
